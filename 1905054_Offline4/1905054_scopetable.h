...
public:
    ...
    {
        int parent_variable_count = parent_scope !=nullptr ? parent_scope->get_variable_count(): 0;

        return variable_count + parent_variable_count;   

    }

    void variable_count_add(int cnt)
    {
        if(cnt>0){
